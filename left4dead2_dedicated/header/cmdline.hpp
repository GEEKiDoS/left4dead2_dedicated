...
// Interface define from icommandline.h
class ICommandLine
{
public:
...
static ICommandLine* g_pCommandLine = nullptr;

inline void InitCommandLine()
{
	g_pCommandLine = reinterpret_cast<ICommandLine*>(GetProcAddress(GetModuleHandle("tier0.dll"), "CommandLine_Tier0")());
}
